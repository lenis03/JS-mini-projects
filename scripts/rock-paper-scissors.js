...
function showResetConfirm() {
  document.querySelector('.js-confirm-message').innerHTML = `
    <p>Are you sure you would like to reset the score?</p>
    <button class="js-reset-confirm reset-confirm">Yes</button>
    <button class="js-reset-reject reset-reject">No</button>
  `;
}
...
document.querySelector('.js-reset-reject').addEventListener('click', () => {
  hideResetConfirm();
});
